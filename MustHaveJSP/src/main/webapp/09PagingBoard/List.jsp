...
String searchField = request.getParameter("seachField"); // 검색 필드 생성
String searchWord = request.getParameter("seachWord"); // 검색 내용 생성
...
List<BoardDTO> boardLists = dao.selectListPage(param); // 게시물 목록 받기(위에서 만든 파라미터 값을 매개값으로)
dao.close(); // DB 연결 닫기
%>    
